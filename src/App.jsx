...
function App() {
  const images = [
    "https://media.istockphoto.com/id/1346853640/photo/saving-money-concept-man-hand-putting-row-and-coin-write-finance-saving-money-concept-man.jpg?s=612x612&w=0&k=20&c=1I48V9GUU0liAJ-dMA4SW-h5LoejkBTlEZJ-0b_vmXE=",
    "https://images.unsplash.com/photo-1579621970795-87facc2f976d?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8ZmluYW5jZXxlbnwwfHwwfHx8MA%3D%3D",
    "https://plus.unsplash.com/premium_photo-1661774987792-17a95638d874?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGZpbmFuY2V8ZW58MHx8MHx8fDA%3D",
  ];
      ...
      <div>
        ...
        <header className="fixed top-0 left-0 w-full z-50">
          ...
          <div className="text-gray-800 font-medium flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-8 py-4 px-4 bg-white">
            <a href="/" className="text-2xl sm:text-3xl font-bold cursor-pointer">The Capital Money</a>
        ...
        <main>
          ...
          <section id="category1" className="relative w-full h-[300px] sm:h-[500px] flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-black text-center px-4">
              <h2 className="text-2xl sm:text-4xl font-extrabold">The Capital Money</h2>
            ...
            <div className="flex flex-col lg:flex-row-reverse items-center gap-6">
              ...
              <div className="w-full lg:w-1/2">
                ...
                <p className="text-sm sm:text-base">
                 The Capital Money Pvt. Ltd. is dealing in Home Loan, Personal Loan, Agriculture Loan, Shop Loan, Flat Loan, Project Loan, Education Loan, Pay Slip Loan, Car Loan, Machine Loan, Business Loans, Loan Against Property & Project Etc.
                </p>
         ...
         <section
  id="category3"
  className="min-h-screen flex flex-col justify-center bg-amber-50 px-4 py-6"
>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
    {[
      { title: "Personal Loan", img: "https://plus.unsplash.com/premium_photo-1661774987792-17a95638d874?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGZpbmFuY2V8ZW58MHx8MHx8fDA%3D" },
      { title: "Home Loan", img: home },
      { title: "Education Loan", img: "https://plus.unsplash.com/premium_photo-1661774987792-17a95638d874?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGZpbmFuY2V8ZW58MHx8MHx8fDA%3D" },
      { title: "Business Loan", img: home },
    ].map((service, i) => (
      <div
        key={i}
        className="shadow rounded-2xl bg-blue-100 overflow-hidden flex flex-col"
      >
        <img
          src={service.img}
          alt=""
        ...
        <div className="p-4 flex flex-col items-center text-center flex-1">
          ...
          <p className="text-sm">
            Get {service.title} on Easy EMI basis from The Capital Money.
          </p>
          <a
            href="/personal"
            className="mt-1 bg-[#0e7490] rounded-2xl py-2 px-4 text-white cursor-pointer "
          >
            Read More
          </a>
        </div>
